    ...
    class Program
    {
        ...
        sealed public class Eve : Female
        {
            ...
            public static Eve GetInstance(Adam adam)
            {
                ...
                {
                    throw new ArgumentNullException("Eve no viene de Adam");
                }
            }
        }
        ...
        public static class SampleTests
        {
            ...
            {
                Assert.Throws<ArgumentNullException>(() => Eve.GetInstance(Adam.GetInstance()));
            }
            /*
            ...
            */
            ...
            static void Main(string[] args)
            {
                ...
                Adam_is_unique_and_cannot_be_overriden();
                Adam_is_a_human();
                Adam_is_a_male();
                Eve_is_unique_and_created_from_a_rib_of_adam();
                Eve_can_only_be_create_of_a_rib_of_adam();
            }
        }
